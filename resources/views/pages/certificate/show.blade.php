                    ...
                    <div class="my-5">
                        <div class="outer-border">
                            <div class="inner-dotted-border">
                                   ...
                                   <span class="fs-30"><strong class="course text-decortion-italic">{{ $certificate->category->name }}</strong></span> <br/><br/>

                                   <span class="fs-20">With score of <b><strong class="text-decortion-italic">{{ $certificate->grade }}</strong></b></span> <br/><br/><br>
                                <div class="date">
                                   <p class=" text-start fs-20">{{ $certificate->issue_date }}</p>
