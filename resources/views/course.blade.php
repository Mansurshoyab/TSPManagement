                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input name="crs_name" class="form-control" type="text" placeholder="Course Name">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Course Subject : </label>
                                            <input name="crs_sub" class="form-control" type="text" placeholder="Course Subject">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <input name="crs_du" class="form-control" type="text" placeholder="Course Duretion">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            <label>StartDate : </label>
                                            <input name="st_date" class="form-control" type="date" placeholder="Course Duretion">
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label>Course Fee : </label>
                                            <input name="crs_fee" class="form-control" type="text" placeholder="Unit Price">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
