...
<head>
    ...
    <link href="{{ asset('/') }}admin/asset/css/certificate.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">TSP Management</div>
            </a>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="{{ asset('/') }}admin/asset/img/undraw_rocket.svg" alt="...">
                <p class="text-center mb-2"><strong>Billing System</strong> is packed with premium features, components, and more!</p>
